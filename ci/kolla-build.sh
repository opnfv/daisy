...
# This calls into the kolla code which is used for building such images, 
# so it should be executed after the images are built.
...
function pack_registry_data {
    ...
    echo $KOLLA_GIT_VERSION > registry-$version-$datetag.versioni
