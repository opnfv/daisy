...
net_struct = {
    ...
    'interfaces': [
        {'name': 'EXTERNAL', 'interface': 'ens44f1'},
        {'name': 'MANAGEMENT', 'interface': 'ens12f0'},
        {'name': 'PUBLICAPI', 'interface': 'ens12f0'},
        {'name': 'STORAGE', 'interface': 'ens12f1'},
        {'name': 'TENANT', 'interface': 'ens44f0'},
        {'name': 'TENANT', 'interface': 'ens44f0'}
    ],
