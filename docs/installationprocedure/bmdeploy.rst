...
(6) Config the bridge in jumperserver,use the command below:
brctl addbr br7
brctl addif br7 enp3s0f3
ifconfig br7 up
...
(7) When deploy successfully,the floating ip of openstack is 10.20.7.11,the login account is "admin" and the password is "keystone"
