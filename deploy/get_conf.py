...
def config(dha_file, network_file):
    data = init(dha_file)
    host_interface_map, host_role_map, host_ip_passwd_map = dha_config_parse(data, dha_file)
    data = init(network_file)
    network_map, vip = network_config_parse(data, network_file)
    return host_interface_map, host_role_map, host_ip_passwd_map, network_map, vip
