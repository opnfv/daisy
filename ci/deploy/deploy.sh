...
#########if environment can be rebuild ,then can delete clean deploy environment code########
echo "====== clean deploy environment==========="
sshpass -p ossdbg1 ssh 192.168.122.152 -o UserKnownHostsFile=/dev/null -oStrictHostKeyChecking=no "/home/daisy/forDel/tools/cleanup-containers"
sshpass -p ossdbg1 ssh 192.168.122.152 -o UserKnownHostsFile=/dev/null -oStrictHostKeyChecking=no "/home/daisy/forDel/tools/cleanup-images"
